...
finesse blur, and one for a mask made of neither, so the legacy window and key
form is not free). A fold at the feather cap is about 59 ms of numpy at
